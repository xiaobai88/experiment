...
avg0_top1_accuracy=binary_accuracy(ground_truth_offsets_grouped,avg0_top1_offsets);
avg0_top5_accuracy=binary_accuracy(ground_truth_offsets_grouped,avg0_top5_offsets);
avg0_top10_accuracy=binary_accuracy(ground_truth_offsets_grouped,avg0_top10_offsets);

avg1_top1_accuracy=binary_accuracy(ground_truth_offsets_grouped,avg1_top1_offsets);
avg1_top5_accuracy=binary_accuracy(ground_truth_offsets_grouped,avg1_top5_offsets);
avg1_top10_accuracy=binary_accuracy(ground_truth_offsets_grouped,avg1_top10_offsets);
...
avg0_top1_recall_avg=recall_average(ground_truth_offsets_grouped,avg0_top1_offsets);
avg0_top5_recall_avg=recall_average(ground_truth_offsets_grouped,avg0_top5_offsets);
avg0_top10_recall_avg=recall_average(ground_truth_offsets_grouped,avg0_top10_offsets);

avg1_top1_recall_avg=recall_average(ground_truth_offsets_grouped,avg1_top1_offsets);
avg1_top5_recall_avg=recall_average(ground_truth_offsets_grouped,avg1_top5_offsets);
avg1_top10_recall_avg=recall_average(ground_truth_offsets_grouped,avg1_top10_offsets);
